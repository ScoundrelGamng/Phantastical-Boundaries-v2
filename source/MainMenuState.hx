...
//		#if !switch 'donate', #end
	...
	override function create()
	{
		...
		var logoBl:FlxSprite;
			...
			var menuItem:FlxSprite = new FlxSprite(900, 370);
			...
			// FreePlay Mode
			var offset:Float = 108 - (Math.max(optionShit.length, 4) - 4) * 80;
			var menuItem:FlxSprite = new FlxSprite(900, 470);
			menuItem.scale.x = scale;
			menuItem.scale.y = scale;
			...
			// Credits
			var offset:Float = 108 - (Math.max(optionShit.length, 4) - 4) * 80;
			var menuItem:FlxSprite = new FlxSprite(900, 570);
			menuItem.scale.x = scale;
			menuItem.scale.y = scale;
			...
			// Options
			var offset:Float = 108 - (Math.max(optionShit.length, 4) - 4) * 80;
			var menuItem:FlxSprite = new FlxSprite(900, 650);
			menuItem.scale.x = scale;
			menuItem.scale.y = scale;
			...
			//logo bumpin
			logoBl = new FlxSprite(650, -140);
			logoBl.frames = Paths.getSparrowAtlas('logoBumpin');
			logoBl.setGraphicSize(550);
	...
	//	FlxG.camera.follow(camFollowPos, null, 1);
		...
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "FNF: Phantastical Boundaries by Studio Sukima", 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
